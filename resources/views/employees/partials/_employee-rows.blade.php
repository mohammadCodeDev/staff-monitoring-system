...
<tr>
    ...
    {{-- Safely access group name (your code for group was already correct, this is just for consistency) --}}
    <td class="px-6 py-4 whitespace-nowrap">{{ __($employee->group?->name) }}</td>
