...
<div x-data="{ show: false }" class="relative">
    ...
    <div class="absolute inset-y-0 end-0 pe-3 flex items-center">
        <button type="button" @click="show = !show" class="text-gray-500 dark:text-gray-400 focus:outline-none" aria-label="Toggle password visibility">
            {{-- Eye Icon --}}
            ...
            {{-- Eye-slashed Icon --}}
            <svg x-show="show" style="display: none;" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
