<aside class="w-64 bg-white dark:bg-gray-800 p-4 space-y-6 border-r border-gray-200 dark:border-gray-700 rtl:border-l rtl:border-r-0">
    ...
    <div>
        ...
        <div class="flex flex-col space-y-2">
            ...
            <x-sidebar-link :href="route('employees.create')" :active="request()->routeIs('employees.create')">{{ __('Add New Employee') }}</x-sidebar-link>
            <x-sidebar-link :href="route('employees.index')" :active="request()->routeIs('employees.index', 'employees.show', 'employees.edit')">{{ __('View All Employees') }}</x-sidebar-link>
